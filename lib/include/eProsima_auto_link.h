...
/*
   Expected defines.
   - EPROSIMA_LIB_NAME
   - FASTDDS_QOS_PROFILES_MANAGER_VERSION_MAJOR
   - FASTDDS_QOS_PROFILES_MANAGER_VERSION_MINOT
 */
...
// Include library
    ...
    && defined(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MAJOR) \
    && defined(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MINOR)
        #pragma \
    comment(lib, EPROSIMA_LIB_PREFIX EPROSIMA_STRINGIZE(EPROSIMA_LIB_NAME) EPROSIMA_LIB_DEBUG_TAG "-" EPROSIMA_STRINGIZE(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MAJOR) "." EPROSIMA_STRINGIZE(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MINOR) ".lib")
    #else
    #error "Some required macros where not defined"
    #endif // if defined(EPROSIMA_LIB_NAME) && defined(EPROSIMA_LIB_PREFIX) && defined(EPROSIMA_LIB_DEBUG_TAG) && defined(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MAJOR) && defined(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MINOR)
