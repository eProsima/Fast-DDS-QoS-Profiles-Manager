...
*/
	...
	&& defined(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MINOR)
        #pragma comment(lib, EPROSIMA_LIB_PREFIX EPROSIMA_STRINGIZE(EPROSIMA_LIB_NAME) EPROSIMA_LIB_DEBUG_TAG "-" EPROSIMA_STRINGIZE(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MAJOR) "." EPROSIMA_STRINGIZE(FASTDDS_QOS_PROFILES_MANAGER_VERSION_MINOR) ".lib")
    #else
