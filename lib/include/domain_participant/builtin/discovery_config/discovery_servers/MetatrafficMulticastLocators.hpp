...
#ifndef _FAST_DDS_QOS_PROFILES_MANAGER_DOMAIN_PARTICIPANT_BUILTIN_DISCOVERY_CONFIG_DISCOVERY_SERVERS_METATRAFFIC_MULTICAST_LOCATORS_HPP_
#define _FAST_DDS_QOS_PROFILES_MANAGER_DOMAIN_PARTICIPANT_BUILTIN_DISCOVERY_CONFIG_DISCOVERY_SERVERS_METATRAFFIC_MULTICAST_LOCATORS_HPP_
...
/**
 * @brief Parse XML file and print specific Domain Participant remote server metatraffic multicast locator list.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
 *
 * @return std::string XML section containing the specific Domain Participant remote server metatraffic multicast
 *         locator list.
 *
 ...
 *        file, or the metatraffic multicast locator list is not found.
 */
...
/**
 * @brief Remove specific Domain Participant remote server metatraffic multicast locator list.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Append a remote server metatraffic multicast locator with specified kind.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Update the remote server metatraffic multicast locator kind.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Update the remote server metatraffic multicast locator port.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Update the remote server metatraffic multicast locator physical port (TCP only).
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Update the remote server metatraffic multicast locator IP address.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Update the remote server metatraffic multicast TCPv4 locator unique LAN ID.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
/**
 * @brief Update the remote server metatraffic multicast TCPv4 locator WAN address.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] prefix Remote server GUID prefix.
...
#endif // _FAST_DDS_QOS_PROFILES_MANAGER_DOMAIN_PARTICIPANT_BUILTIN_DISCOVERY_CONFIG_DISCOVERY_SERVERS_METATRAFFIC_MULTICAST_LOCATORS_HPP_
