...
/**
 * @brief Parse XML file and print specific Domain Participant builtin metatraffic unicast locator list.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 *
 * @return std::string XML section containing the specific Domain Participant builtin metatraffic unicast locator list.
 *
 ...
 *        builtin metatraffic unicast locator list element does not exist.
 */
...
/**
 * @brief Remove specific Domain Participant builtin metatraffic unicast locator list.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 *
...
/**
 * @brief Append a builtin metatraffic unicast locator with specified kind.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
...
/**
 * @brief Update the builtin metatraffic unicast locator kind.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] kind Metatraffic unicast locator kind.
...
/**
 * @brief Update the builtin metatraffic unicast locator port.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] port Metatraffic unicast locator port.
...
/**
 * @brief Update the builtin metatraffic unicast locator physical port (TCP only).
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] physical_port Metatraffic unicast locator TCP physical port.
...
/**
 * @brief Update the builtin metatraffic unicast locator IP address.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] address Metatraffic unicast locator IP address.
...
/**
 * @brief Update the builtin metatraffic unicast TCPv4 locator unique LAN ID.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] unique_lan_id Metatraffic unicast TCPv4 locator unique LAN ID.
...
/**
 * @brief Update the builtin metatraffic unicast TCPv4 locator WAN address.
 *
 * @param[in] xml_file Absolute/relative path to the XML file.
 * @param[in] profile_id Domain participant profile identifier.
 * @param[in] wan_address Metatraffic unicast TCPv4 locator WAN address.
