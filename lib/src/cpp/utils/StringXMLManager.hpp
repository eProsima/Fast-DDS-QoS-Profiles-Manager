...
#ifndef _FAST_DDS_QOS_PROFILES_MANAGER_UTILS_STRING_XML_MANAGER_HPP_
#define _FAST_DDS_QOS_PROFILES_MANAGER_UTILS_STRING_XML_MANAGER_HPP_
...
#endif // _FAST_DDS_QOS_PROFILES_MANAGER_UTILS_STRING_XML_MANAGER_HPP_
