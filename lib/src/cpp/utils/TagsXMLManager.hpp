...
#ifndef _FAST_DDS_QOS_PROFILES_MANAGER_UTILS_XML_MANAGER_TAGS_HPP_
#define _FAST_DDS_QOS_PROFILES_MANAGER_UTILS_XML_MANAGER_TAGS_HPP_
...
#endif // _FAST_DDS_QOS_PROFILES_MANAGER_UTILS_XML_MANAGER_TAGS_HPP_
