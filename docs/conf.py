...
PROJECT_NAME = 'Fast DDS QoS Profiles Manager'
COMPRESS_PROJECT_NAME = 'fastddsqosprof'
...
def configure_doxyfile(
    ...
    :param input_dir: lib/CMakeLists.txt value of PROJECT_SOURCE_DIR
    :param output_dir: lib/CMakeLists.txt value of CMAKE_INSTALL_PREFIX
    """
    ...
    filedata = filedata.replace('@CMAKE_INSTALL_PREFIX@', output_dir)
...
if read_the_docs_build:
    print('Read the Docs environment')

    doxygen_html = os.path.abspath('{}/doxygen/html'.format(project_binary_docs_dir))
    # Doxyfile
    doxyfile_in = os.path.abspath('{}/../lib/doxyfile.in'.format(script_path))
    doxyfile_out = os.path.abspath('{}/doxyfile'.format(project_binary_docs_dir))
    # Header files
    input_dir = os.path.abspath('{}/../lib'.format(script_path))
